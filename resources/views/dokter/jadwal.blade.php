                ...
                <tbody>
                    @foreach($data as $jadwal)
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-warning btn-sm" onclick="editJadwal({{ $jadwal }})">Edit</button>
                                <form action="{{ route('dokter.jadwal.destroy', $jadwal->id) }}" id="deleteForm_{{ $jadwal->id }}" method="POST" style="display:inline-block;">
                                    @csrf
                                    @method('DELETE')
                                    <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete({{ $jadwal->id }})">Delete</button>
                                </form>
                            </td>
                        </tr>
                    @endforeach
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="time" class="form-control" step="2" name="jam_mulai" id="edit_jam_mulai" required>
                        </div>
                        <div class="mb-3">
                            <label for="edit_jam_selesai" class="form-label">Jam Selesai:</label>
                            <input type="time" class="form-control" step="2" name="jam_selesai" id="edit_jam_selesai" required>
                        </div>
                        <div class="mb-3">
